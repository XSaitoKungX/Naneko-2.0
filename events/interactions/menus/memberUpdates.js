...
module.exports = async(interaction, client) => {
    ...
    if (interaction.values[0] === "member_updates") {
        ...
        if (!data) {
            await msg.edit("Bitte senden Sie die **CHANNEL ID**, um die Mitgliederaktualisierungsprotokolle einzurichten")
            ...
            collector.on('collect', async(collected, returnValue) => {
                ...
                return msg.edit(`Member-Updates werden in --> ${interaction.guild.channels.cache.get(channelID)} angezeigt.`)
            })
            ...
            return msg.edit(`Die Protokollierung von Mitgliederaktualisierungen wurde gestoppt!`)
        }
    }
}